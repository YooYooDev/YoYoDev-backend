...
public interface AssignmentRepository extends CrudRepository<Assignment, Integer> {
	...
	public static String GET_ASSIGNMENTS_BY_SCHOOL_AND_MONTH = "select a from Assignment a where a.school.id = :schoolId and DATE_FORMAT(a.date, '%b') = :month";

	@Query(GET_ASSIGNMENTS_BY_SCHOOL)
	public List<Assignment> getAssignmentsBySchool(@Param("schoolId") Integer schoolId);
